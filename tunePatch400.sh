...
python /work/t113618009/ssast_hub/ssast-main/src/run.py \
  ...
  --target_length 1024 \
  --num_mel_bins 128 \
  --exp-dir "/work/t113618009/ssast_hub/exp/finetune/epoch30/tunePatch400" \
  --lr 0.00005 \
  --n-epochs 40 \
  --batch-size 12 \
  --save_model True \
  ...
  --model_size base \
  --adaptschedule False \
  --pretrained_mdl_path "/work/t113618009/ssast_hub/ssast-main/pretrained_model/SSAST-Base-Patch-400.pth" \
