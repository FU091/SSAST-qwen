...
#SBATCH --partition=gp2d         ## 使用 gp2d partition (最長跑2天)
#SBATCH --time=48:00:00          ## 設定時間 (需小於 96 小時)
#SBATCH -o /work/t113618009/ssast_hub/logs/Patch400_%j.out
#SBATCH -e /work/t113618009/ssast_hub/logs/Patch400_%j.err
...
python /work/t113618009/ssast_hub/ssast-main/src/run.py \
  ...
  --target_length 1024 \
  --num_mel_bins 128 \
  --exp-dir "/work/t113618009/ssast_hub/exp/finetune/epoch40/tunePatch400_small" \
  --lr 0.0001 \
  --n-epochs 40 \
  --batch-size 64 \
  --save_model True \
  ...
  --model_size small \
  --adaptschedule False \
  --pretrained_mdl_path "/work/t113618009/ssast_hub/ssast-main/pretrained_model/SSAST-Small-Patch-400.pth" \
